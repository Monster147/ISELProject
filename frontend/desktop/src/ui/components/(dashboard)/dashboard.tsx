...
const Dashboard = () => {
    ...
    const {getOverviewStats, getStatsReportByType, getStatsReportByStatus, getStatsOccurrenceByImportance, getStatsReportByTypeThisMonth, getStatsReportByStatusThisMonth, getStatsOccurrenceByImportanceThisMonth} = useStats()
    const {type}= useType()
