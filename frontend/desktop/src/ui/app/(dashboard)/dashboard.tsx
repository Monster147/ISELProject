...
const Dashboard = () => {
  ...
  const [byImportanceMonth, setByImportanceMonth] = useState<
      ...
      <ThemedView style={styles.grid}>
        ...
        <ThemedCard style={styles.kpiCard}>
          <ThemedText style={styles.label}>
            {t("stats.totalOccurrences")}
          </ThemedText>
          <ThemedText style={styles.value}>
            {overview?.totalOccurrences ?? `—`}
          </ThemedText>
        </ThemedCard>
        <ThemedCard style={styles.kpiCard}>
          <ThemedText style={styles.label}>
        ...
        <ThemedCard style={styles.kpiCard}>
          <ThemedText style={styles.label}>
            {t("stats.totalEvidences")}
          </ThemedText>
          <ThemedText style={styles.value}>
            {overview?.totalEvidences ?? `—`}
          </ThemedText>
        </ThemedCard>
      </ThemedView>
  ...
  return (
    <ThemedCard style={styles.chartCard}>
      ...
      {rows.length === 0 ? (
        ...
        <ThemedView
          style={[styles.chartRow, { backgroundColor: theme.uiBackground }]}
        >
          {rows
            .slice()
