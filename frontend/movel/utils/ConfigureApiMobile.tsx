...
async function downloadDocument(apiBaseUrl: string, id: number): Promise<void> {
    ...
    if (Platform.OS === "android") {
        ...
        Alert.alert("Download concluído", "O ficheiro foi guardado na pasta Downloads.");
        return;
    }
...
async function downloadEvidence(apiBaseUrl: string, id: number, authHeaders: HeadersInit, keep: Boolean): Promise<any> {
