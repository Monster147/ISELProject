...
import {useListenAllListener, SSEMessage} from "../hooks/useListenAllListener";
...
export const SyncSSEContext = createContext<SyncSSEContextValue | undefined>(undefined)
