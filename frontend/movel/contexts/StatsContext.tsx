...
/**
 * Provider que disponibiliza as operações de estatísticas na aplicação móvel.
 * Não mantém estado local — todas as operações delegam diretamente na API.
 *
 * @param children Árvore de componentes que terão acesso ao contexto de estatísticas.
 */
