...
export const StatsContext = createContext<StatsContextValue | undefined>(undefined)
...
export function StatsProvider({children}) {
    ...
    return (
        <StatsContext.Provider value={{getOverviewStats, getStatsReportByType, getStatsReportByStatus, getStatsOccurrenceByImportance, getStatsReportByTypeThisMonth, getStatsReportByStatusThisMonth, getStatsOccurrenceByImportanceThisMonth}}>
            {children}
