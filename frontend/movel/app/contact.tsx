import { Pressable, StyleSheet, Image, useColorScheme, Linking } from "react-native";
      ...
      <ThemedView style={styles.container}>
        <ThemedView style={styles.cardsContainer}>
          <ThemedCard style={styles.card}>
            ...
            >
              <Pressable
                  onPress={() => openUrl("https://github.com/Monster147")}
              >
                <FontAwesome
                    name="github"
                    size={28}
              ...
              <Pressable
                  onPress={() =>
                      openUrl("mailto:A51445@alunos.isel.pt")
                  }
              >
                <MaterialIcons
                    name="email"
          ...
          <ThemedCard style={styles.card}>
            ...
            >
              <Pressable
                  onPress={() => openUrl("https://github.com/AJesus1227")}
              >
                <FontAwesome
                    name="github"
                    size={28}
              ...
              <Pressable
                  onPress={() =>
                      openUrl("mailto:A51561@alunos.isel.pt")
                  }
              >
                <MaterialIcons
                    name="email"
