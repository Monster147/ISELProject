    ...
    if (field.type === "image" || field.type === "file") {
        ...
        if (isImage) {
            ...
            return (
                <ThemedView
                    ...
                    <TouchableOpacity activeOpacity={0.8} onPress={() => handleDownloadFile(value)}>
        ...
        return (
            <ThemedView style={[styles.fieldContainer, {backgroundColor: theme.uiBackground}]}>
                ...
                {field.type === "image" ? (
                    <ThemedView style={[styles.imageButtonsContainer, {backgroundColor: theme.uiBackground}]}>
                        <ThemedButton style={styles.imageActionButton} onPress={() => handleMediaPick("gallery")}>
                            <ThemedText style={styles.downloadButtonText}> Galeria </ThemedText>
                        </ThemedButton>

                        <ThemedButton onPress={() => handleMediaPick("camera")} style={styles.imageActionButton}>
                            <ThemedText style={styles.downloadButtonText}> Câmara </ThemedText>
                        </ThemedButton>
                    </ThemedView>
                ) : (
