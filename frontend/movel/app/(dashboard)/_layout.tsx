  ...
  return (
    <UserOnly>
      ...
      >
        ...
        />
        <Tabs.Screen name="occurrences/[id]" options={{ href: null }} />
        <Tabs.Screen name="intervenors/[id]" options={{ href: null }} />
        <Tabs.Screen name="intervenors/create" options={{ href: null }} />
        <Tabs.Screen
