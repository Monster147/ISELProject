...
/**
 * Hook que subscreve atualizações da lista de tipos de ocorrência em tempo real via SSE (React Native).
 * Usa react-native-sse para abrir uma ligação ao endpoint `/api/type/listen`.
